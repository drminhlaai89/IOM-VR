...
namespace Evereal.VRVideoPlayer
{
  public class AVProMediaPlayer : IMediaPlayer
  {
    ...
    public string url
    {
      get { return mediaPlayer.m_VideoPath; }
      set { mediaPlayer.m_VideoPath = value; }
    }
    ...
    public double time
    {
      get { return (double)(mediaPlayer.Control.GetCurrentTimeMs() / 1000); }
    ...
    {
      get { return (double)(mediaPlayer.Info.GetDurationMs() / 1000); }
    }
